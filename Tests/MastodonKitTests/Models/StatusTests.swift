...
class StatusTests: XCTestCase {
  func testStatusWithNullFromJSON() throws {
    ...
    XCTAssertEqual(status.content.asRawText, "This is a very very long status message posted on Mastodon. OK, not that long because I'm lazy and don't want to type a long fixture.")
  ...
  func testStatusWithHTMLContentFromJSON() throws {
      let fixture = try Fixture.load(fileName: "Fixtures/StatusWithHTMLContent.json")
      let status = try Status.decode(data: fixture)
